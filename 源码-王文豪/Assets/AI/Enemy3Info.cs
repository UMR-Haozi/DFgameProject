...
public class Enemy3Info : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        if (isTrigger)
        {
            ...
            {
                gameObject.GetComponent<Renderer>().material.mainTexture = (Texture)Resources.Load("Img/enemy3");
            }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (life == 0)
        {
            GameObject.Find("Player").GetComponent<PlayerInfo>().addScore(Random.Range(1000, 1500));
